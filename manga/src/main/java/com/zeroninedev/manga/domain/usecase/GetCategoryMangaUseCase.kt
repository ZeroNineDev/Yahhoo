 ...
 */
internal class GetCategoryMangaUseCase @Inject constructor(private val repository: MangaRepository) {

    /**
     * @return flow of mangas with pagination
     */
    operator fun invoke(categoryId: String): Flow<PagingData<UpdatedManga>> = repository.categoryManga(categoryId)
}